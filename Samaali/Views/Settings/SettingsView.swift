        ...
        NavigationStack {
            Form {
                ...
                Section {
                    ...
                    Text("Choose how Samaali looks. System follows your device settings.")
                }
    ...
    var body: some View {
        Form {
            Section {
                ...
                Text("When enabled, Samaali can import your Screen Time data to automatically track app usage.")
            }
