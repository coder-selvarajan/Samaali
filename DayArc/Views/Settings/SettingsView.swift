        ...
        NavigationStack {
            Form {
                ...
                Section {
                    ...
                    Text("Choose how DayArc looks. System follows your device settings.")
                }
    ...
    var body: some View {
        Form {
            Section {
                ...
                Text("When enabled, DayArc can import your Screen Time data to automatically track app usage.")
            }
